...
const Banner = () => {
  return <section className='h-full max-h-[640px] mb-8 xl:mb-24'>
    <div className='flex flex-col lg:flex-row'>
      <div className=' xl:ml-[135px] flex flex-col items-center lg:items-start text-center
      lg:text-left justify-center flex-1 px-4 lg:px-0'>
        ...
        <p className='max-w-[480px] mb-8'>Lorem Ipsum is simply dummy text of the printing and 
      ...
      <div className='hidden flex-1 lg:flex justify-end items-end '>
        <img src={Image} alt='' className='rounded-tl-[100px] border'/>
      </div>
    </div>
    <Search/>
  </section>;
